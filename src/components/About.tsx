...
//       description: '400+ DSA problems solved across multiple platforms',
//       delay: '0s'
//     },
//     { 
//       icon: <Users className="w-8 h-8" />, 
//       title: 'Leadership', 
//       description: 'Led multiple technical communities and organized events',
//       delay: '0.1s'
//     },
//     { 
...
//       title: 'Goal-Oriented', 
//       description: 'Focused on achieving measurable results and outcomes',
//       delay: '0.3s'
//     },
//     { 
//       icon: <Lightbulb className="w-8 h-8" />, 
//       title: 'Innovation', 
//       description: 'Creative approach to solving technical challenges',
//       delay: '0.4s'
//     },
//     { 
//       icon: <GraduationCap className="w-8 h-8" />, 
//       title: 'Continuous Learning', 
//       description: 'Always eager to learn new technologies and concepts',
//       delay: '0.5s'
//     },
//   ];
...
//                   My journey has been marked by consistent learning, hands-on project development, and active leadership 
...
//                   I've honed my problem-solving skills and logical thinking abilities. This technical foundation, combined with 
//                   my leadership experience in organizations like <span className="font-semibold text-blue-400">E-Cell, GDG, and Code-D-Code Club</span>, 
//                   has shaped me into a well-rounded developer who can both build and lead.
//                 </p>
//                 <p className="text-secondary leading-relaxed">
//                   I believe in the power of technology to transform ideas into reality, and I'm committed to 
//                   continuous learning and contributing to the tech community through meaningful projects and 
...
//                 <p className="text-muted mt-2">Dr. Ambedkar Institue Of Technology For Divyangjan Kanpur,UP</p>
//               </div>
//             </div>
